...
const file_payment_proto_rawDesc = "" +
	"\n" +
	"\rpayment.proto\x12\x02pb\"\xbd\x03\n" +
	...
	"\apayTime\x18\x0f \x01(\x03R\apayTime\"\x9e\x01\n" +
	...
	"\x02sn\x18\x01 \x01(\tR\x02sn\"M\n" +
	"\x12GetPaymentBySnResp\x127\n" +
	"\rpaymentDetail\x18\x01 \x01(\v2\x11.pb.PaymentDetailR\rpaymentDetail\"?\n" +
	"#GetPaymentSuccessRefundByOrderSnReq\x12\x18\n" +
	"\aorderSn\x18\x01 \x01(\tR\aorderSn\"_\n" +
	"$GetPaymentSuccessRefundByOrderSnResp\x127\n" +
	"\rpaymentDetail\x18\x01 \x01(\v2\x11.pb.PaymentDetailR\rpaymentDetail\"\xe9\x01\n" +
	...
	"\x14UpdateTradeStateResp2\xc6\x02\n" +
	"\apayment\x12<\n" +
	"\rCreatePayment\x12\x14.pb.CreatePaymentReq\x1a\x15.pb.CreatePaymentResp\x12?\n" +
	"\x0eGetPaymentBySn\x12\x15.pb.GetPaymentBySnReq\x1a\x16.pb.GetPaymentBySnResp\x12E\n" +
	"\x10UpdateTradeState\x12\x17.pb.UpdateTradeStateReq\x1a\x18.pb.UpdateTradeStateResp\x12u\n" +
	" GetPaymentSuccessRefundByOrderSn\x12'.pb.GetPaymentSuccessRefundByOrderSnReq\x1a(.pb.GetPaymentSuccessRefundByOrderSnRespB\x06Z\x04./pbb\x06proto3"
...
var file_payment_proto_goTypes = []any{
	(*PaymentDetail)(nil),                        // 0: pb.PaymentDetail
	(*CreatePaymentReq)(nil),                     // 1: pb.CreatePaymentReq
	(*CreatePaymentResp)(nil),                    // 2: pb.CreatePaymentResp
...
var file_payment_proto_depIdxs = []int32{
	0, // 0: pb.GetPaymentBySnResp.paymentDetail:type_name -> pb.PaymentDetail
	0, // 1: pb.GetPaymentSuccessRefundByOrderSnResp.paymentDetail:type_name -> pb.PaymentDetail
	1, // 2: pb.payment.CreatePayment:input_type -> pb.CreatePaymentReq
	...
	2, // 6: pb.payment.CreatePayment:output_type -> pb.CreatePaymentResp
