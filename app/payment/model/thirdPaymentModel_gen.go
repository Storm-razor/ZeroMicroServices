...
var (
	...
	cacheThirdPaymentIdPrefix = "cache:thirdPayment:id:"
	cacheThirdPaymentSnPrefix = "cache:thirdPayment:sn:"
)
...
func (m *defaultThirdPaymentModel) Insert(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	thirdPaymentIdKey := fmt.Sprintf("%s%v", cacheThirdPaymentIdPrefix, data.Id)
	thirdPaymentSnKey := fmt.Sprintf("%s%v", cacheThirdPaymentSnPrefix, data.Sn)
	...
	}, thirdPaymentIdKey, thirdPaymentSnKey)
}

func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	thirdPaymentIdKey := fmt.Sprintf("%s%v", cacheThirdPaymentIdPrefix, id)
	var resp ThirdPayment
	err := m.QueryRowCtx(ctx, &resp, thirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	thirdPaymentSnKey := fmt.Sprintf("%s%v", cacheThirdPaymentSnPrefix, sn)
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, thirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultThirdPaymentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheThirdPaymentIdPrefix, primary)
}
